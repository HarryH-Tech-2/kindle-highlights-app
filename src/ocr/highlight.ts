...
const PROMPT = [
  ...
  'visibly darker gray rectangle compared to the surrounding page background.',
  '',
  ...
  '- Look at the background color behind every word before including it.',
  '  If the background is the lighter page color, that word is not highlighted.',
  '',
